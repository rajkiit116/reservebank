package org.sarb.reservebank.models.impl;
...
import org.sarb.reservebank.models.impl.BaseComponentExporter;
...
public class BaseComponentExporter implements ComponentExporter {
	...
	public String getMessage() {
		return String.format(
				"Hi! from %s! I don't have my own exporter class and am inheriting the default behavior from BaseComponentExporter.java",
